...
class Ui_AptOfflineQtFetch(object):
    def setupUi(self, AptOfflineQtFetch):
        ...
        self.profileFilePath.setGeometry(QtCore.QRect(30, 25, 270, 30))
        self.profileFilePath.setObjectName("profileFilePath")
        self.browseFilePathButton = QtGui.QPushButton(AptOfflineQtFetch)
        self.browseFilePathButton.setGeometry(QtCore.QRect(320, 25, 110, 30))
        ...
        self.startDownloadButton.setGeometry(QtCore.QRect(179, 158, 120, 30))
        icon = QtGui.QIcon()
        ...
        self.cancelButton.setGeometry(QtCore.QRect(319, 158, 111, 30))
        icon1 = QtGui.QIcon()
        ...
        self.lblSelectSig.setGeometry(QtCore.QRect(30, 3, 200, 30))
        font = QtGui.QFont()
        ...
        self.statusProgressBar.setGeometry(QtCore.QRect(30, 217, 410, 20))
        ...
        self.lblStatus.setGeometry(QtCore.QRect(32, 197, 70, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblStatus.setFont(font)
        self.lblStatus.setObjectName("lblStatus")
        self.progressStatusDescription = QtGui.QLabel(AptOfflineQtFetch)
        self.progressStatusDescription.setGeometry(QtCore.QRect(82, 197, 341, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lblThreads.setGeometry(QtCore.QRect(32, 159, 81, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblThreads.setFont(font)
        self.lblThreads.setObjectName("lblThreads")
        self.cancelButton_2 = QtGui.QPushButton(AptOfflineQtFetch)
        self.cancelButton_2.setGeometry(QtCore.QRect(319, 113, 111, 31))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/preferences-other.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cancelButton_2.setIcon(icon2)
    ...
    def retranslateUi(self, AptOfflineQtFetch):
        ...
        self.cancelButton_2.setText(QtGui.QApplication.translate("AptOfflineQtFetch", "Options", None, QtGui.QApplication.UnicodeUTF8))
